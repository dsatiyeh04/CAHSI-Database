      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li> <a href="allabstracts.php"> <i class="icon-pencil-case"></i>Students Abstracts</a></li>
            <li> <a href="reviewer_MentorList.php"> <i class="icon-list"></i>Reviewer, Mentor, Student</a></li>
