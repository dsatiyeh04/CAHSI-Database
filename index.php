...
<!--
            <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Dropdown </a>
              <ul id="dashvariants" class="collapse list-unstyled">
                <li><a href="#"></a></li>
                <li><a href="#">Status of Upload</a></li>
                <li><a href="#">Checklist</a></li>
                <li><a href="#">Resources for Abstract</a></li>
				<li><a href="#">Additional Information</a></li>
              </ul>
            </li>
-->
            <li> <a href="reports.php"> <i class="icon-grid"></i>Reports </a></li>
...
<!--
          <ul class="list-unstyled">
            <li> <a href="#"> <i class="icon-screen"></i>Institution</a></li>
            <li> <a href="#"> <i class="icon-screen"></i>Classification</a></li>
          </ul>
-->
        </nav>
