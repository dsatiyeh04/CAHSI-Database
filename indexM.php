            ...
            <div class="col-lg-3 col-md-6">
              <div class="wrapper to-do">
                <header>
                  ...
                  <p>All steps must be completed for Mentor duties!</p>
                </header>
                <ul class="check-lists list-unstyled">
                  ...
                  <li class="d-flex align-items-center"> 
                    ...
                    <label for="list-2">Revise/Upload/Change Status for all students</label>
                  </li>
                  <li class="d-flex align-items-center"> 
                    <input type="checkbox" id="list-3" name="list-3" class="form-control-custom">
                    <label for="list-3">Accept Uploaded poster for all students</label>
                  </li>
                  <li class="d-flex align-items-center"> 
                  ...
                  <li class="d-flex align-items-center"> 
                    ...
                    <label for="list-5">Volunteer next year to be a Mentor!</label>
                  </li>
                </ul>
              </div>
            </div>
