...
-->
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                <div class="icon"><i class="icon-padnote"></i></div>
                <div class="name"><strong class="text-uppercase">Abstract</strong><span>Submitted</span>
                  <div class="count-number"></div>
                </div>
              </div>
            </div>
...
-->
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Poster Submission</strong><span>Submitted</span>
                  <div class="count-number"> </div>
                </div>
              </div>
            </div>
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Completed Project</strong><span>This year</span>
                  <div class="count-number">Incomplete</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="wrapper to-do">
                <header>
                  ...
                  <p>All steps must be completed to submit your final project</p>
                </header>
