      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><span>Student</span><strong class="text-primary">Registration</strong></div>
...
<!--                <input id="register-Class" type="class" name="registerclass" required>-->
            ...
            <div class="form-group">
                <label for="register-Class" class="label-custom">Classification       </label>
                  <select id="register-Class" name="registerClass">
...
<!--                <input id="register-Class" type="class" name="registerclass" required>-->
            ...
            <div class="form-group">
                ...
                <select id="register-Major" name="registerMajor">
